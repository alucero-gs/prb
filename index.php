...
<html lang="es">
  <head>
    <title>Blog de noticias de la farandula</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
      <div>
          <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #6730af;">
              <a class="navbar-brand" href="/index.html">Notiblog</a>
              ...
              <div class="collapse navbar-collapse" id="collapsibleNavId">
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="#"><img src="img/login.png" alt="Icono login">Login</a>
                      </li>
                      <li class="nav-item">
