  ...
  <div>
    ...
    <div class="table-responsive">
		...
		<tr>
            ...
            <td>
            <a href="editar.php?id=<?php echo $row['id_publicacionmo']?>" class="btn btn-secondary">
	...
	<?php 
	 ...
	 ?>
            ...
            <div class="nueva">
        <a href="../admin/mipublir.html" title="Nueva publicacion" class="btn btn-secondary "><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Nueva publicacion</a>
        </div>
