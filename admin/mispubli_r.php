...
<html lang="es">
  ...
  <div class="container">
		<div class="content">
			<h2>Datos de mi publicación &raquo; Detalles</h2>
			<hr />
			<?php
			...
			<a href="mispubli.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Regresar</a>
		</div>
	</div>
