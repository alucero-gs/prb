...
<html lang="es">
  ...
  <div>
      ...
      <?php
        ...
        ?>
          <a href="agregar.html" class="btn btn-secondary">
                <i class="fas fa-marker">Regresar</i>
              </a>
    ...
    <div class="table-responsive">
		...
		$result_usu=mysqli_query($conn,$sql);
		...
		<tr>
            ...
            <td> *******</td>
            <td>
            <a href="editar.php?id=<?php echo $row['id_moderador']?>" class="btn btn-secondary">
                <i class="fas fa-marker">Editar</i>
              </a>
              </td>
              <td>
              <a href="eliminar.php?id=<?php echo $row['id_moderador']?>" class="btn btn-danger">
	...
	<?php 
	 ...
	 ?>
            ...
            <div class="nueva">
        <a href="../admin/registrom.html" title="Nueva publicacion" class="btn btn-secondary "><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Nueva moderador</a>
        </div>
