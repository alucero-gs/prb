...
<?php
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM publicaciones WHERE id='$nik'");
    ...
    <div class="table-responsive">
			<table class="table table-striped table-bordered">
				...
				<?php
                    ...
                    $sql = mysqli_query($con, "SELECT t2.username, t1.titulo, t1.contenido, t1.fecha FROM publicacion 
                ...
                if (!$sql || mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							<td>
                                <a href="publi_u.php?nik='.$row['username'].'" title="Editar datos" class="btn btn-secondary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Editar</a>
                            </td>
                            <td>
								<a href="publi.php?aksi=delete&nik='.$row['username'].'" title="Eliminar" onclick="return confirm(\'Esta seguro de borrar los datos '.$row['titulo'].'?\')" class="btn btn-secondary btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar</a>
							</td>
						</tr>
						';
						$no++;
